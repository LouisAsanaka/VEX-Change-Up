...
constexpr QLength DRIVE_WHEEL_TRACK            = 13.2_in;
...
constexpr double DRIVE_MAX_VEL   = 0.7;
constexpr double DRIVE_MAX_ACCEL = 2.0;
constexpr double DRIVE_MAX_JERK  = 8.0;

// Controller
constexpr double CONTROLLER_DEADBAND = 0.2;
