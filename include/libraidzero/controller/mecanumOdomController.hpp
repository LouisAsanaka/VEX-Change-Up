...
class MecanumOdomController : public IOdomController {
public:
    /**
     * Mecanum chassis control using odometry.
     *
    ...
    MecanumOdomController(const MecanumOdomController&) = delete;
    MecanumOdomController(MecanumOdomController&& other) = delete;
    MecanumOdomController &operator=(const MecanumOdomController& other) = delete;
    MecanumOdomController &operator=(MecanumOdomController&& other) = delete;
    ~MecanumOdomController();
