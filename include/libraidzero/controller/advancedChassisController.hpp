...
public:
    ...
    AdvancedChassisController(const AdvancedChassisController &) = delete;
    AdvancedChassisController(AdvancedChassisController &&other) = delete;
    AdvancedChassisController &operator=(const AdvancedChassisController &other) = delete;
    AdvancedChassisController &operator=(AdvancedChassisController &&other) = delete;

    ~AdvancedChassisController() override;
