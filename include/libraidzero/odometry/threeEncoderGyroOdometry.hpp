...
class ThreeEncoderGyroOdometry : public okapi::ThreeEncoderOdometry {
    public:
    /**
     ...
     */
    ThreeEncoderGyroOdometry(const okapi::TimeUtil &itimeUtil,
     ...
     */
    okapi::OdomState odomMathStep(const std::valarray<std::int32_t> &itickDiff,
                                  const okapi::QTime &ideltaT) override;
};
