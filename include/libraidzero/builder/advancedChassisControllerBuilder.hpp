...
class AdvancedChassisControllerBuilder {
public:
    /**
     ...
     */
    explicit AdvancedChassisControllerBuilder(
     ...
     */
    AdvancedChassisControllerBuilder &withMotors(const Motor &ileft, const Motor &iright);
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withMotors(const MotorGroup &ileft, const MotorGroup &iright);
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withMotors(const Motor &itopLeft,
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withMotors(const MotorGroup &itopLeft,
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withSensors(const ADIEncoder &ileft, const ADIEncoder &iright);
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withOdometry(const StateMode &imode = StateMode::FRAME_TRANSFORMATION,
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withOdometry(const ChassisScales &iodomScales,
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withDerivativeFilters(
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withMaxVelocity(double imaxVelocity);
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withMaxVoltage(double imaxVoltage);
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &withClosedLoopControllerTimeUtil(double iatTargetError = 50,
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &parentedToCurrentTask();
     ...
     * @return An ongoing builder.
     */
    AdvancedChassisControllerBuilder &notParentedToCurrentTask();
...
private:
    ...
    std::shared_ptr<AdvancedChassisController> buildACCPID();
    std::shared_ptr<ChassisControllerIntegrated> buildCCI();
    std::shared_ptr<AdvancedOdomChassisController>
    buildAOCC(std::shared_ptr<ChassisController> chassisController);
